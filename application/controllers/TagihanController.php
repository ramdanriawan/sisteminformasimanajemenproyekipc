...
class TagihanController extends CI_Controller 
{
    ...
    public function create($proyek = null) // parameter null supaya gak error waktu gak ada parameter
    {
        ...
        $this->Helper->view('tagihan/create', $data);
    }
    ...
    public function store()
    {
        ...
        if ( !$this->form_validation->run() ) return $this->Helper->view('tagihan/create', $data);
    ...
    public function update()
    {
        ...
        $data['proyeks'] = $this->db->get($this->Proyek->table)->result();
        $data['id'] = $this->input->post('id');
        if ( !$this->form_validation->run() ) return $this->Helper->view("tagihan/{$this->input->post('id')}/edit", $data);
    ...
    {
        $data['datas'] = $this->db->where(['proyek_id' => $proyek])->get($this->Tagihan->table)->result();
