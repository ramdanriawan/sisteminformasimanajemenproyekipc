					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="basic-login-inner">
								...
								<form action="<?php echo base_url("index.php/proyek/$data->id/update"); ?>" method='post'>
										...
										<div class="row">
											...
											<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
												<input name='id' type="number" class="form-control bg-dark color-orange"
													value='<?php echo $data->id ?? set_value('id'); ?>' readonly required>
										...
										<div class="row">
											...
											<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
												<textarea name='nama_proyek' class="form-control"
													placeholder="Input Nama Proyek" required maxlength='255'><?php echo $data->nama_proyek ?? set_value('nama_proyek'); ?></textarea>
										...
										<div class="row">
											...
											<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
												<input name='nomor_kontrak'
													value='<?php echo $data->nomor_kontrak ?? set_value('nomor_kontrak'); ?>' type="text"
										...
										<div class="row">
											...
											<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
												<input name='nilai_kontrak' type="text" class="form-control cleave1"
													value='<?php echo $data->nilai_kontrak ?? set_value('nilai_kontrak'); ?>' required maxlength="21">
												<?php echo "<label class='text-danger'>" . form_error('nomor_kontrak') . "</label>"; ?>
											</div>
										</div>
									</div>
											...
											<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
												<select class="form-control custom-select-value" name="user_id" required>
													<?php foreach($users as $user): ?>
														<option value='<?php echo $user->id; ?>' <?php echo $data->user_id == $user->id ? "selected" : ""; ?>><?php echo $user->nama_lengkap; ?></option>
													<?php endforeach; ?>
												</select>
									...
									<div class="form-group-inner">
										<div class="row">
											...
											<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
												<input type="date" value='<?php echo $data->tanggal_mulai ?? set_value('tanggal_mulai'); ?>'
									...
									<div class="form-group-inner">
										<div class="row">
											...
											<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
												<input type="date" value='<?php echo $data->tanggal_selesai ?? set_value('tanggal_selesai'); ?>'
										...
										<div class="row">
											...
											<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
												<input name='progress' type="number" class="form-control"
													value='<?php echo $data->progress ?? set_value('progress'); ?>' required min="0" max='100'>
