					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="basic-login-inner">
								...
								<form action="<?php echo base_url("index.php/uraian_kerja/store"); ?>" method='post'>
										...
										<div class="row">
											...
											<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
												<textarea name='judul_uraian_kerja' class="form-control"
													placeholder="Input Judul Uraian Kerja" required maxlength='255'><?php echo set_value('judul_uraian_kerja'); ?></textarea>
									...
									<div class="form-group-inner">
										<div class="row">
											...
											<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
												<input type="number" value='<?php echo set_value('jumlah_list_uraian_kerja') !== "" ? set_value('jumlah_list_uraian_kerja') : 1; ?>' id='jumlah_list_uraian_kerja'
										...
										<div class='list_uraian_kerja_detail'>
											...
											<div class="form-group-inner">
												<div class="row">
													...
													<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
														<textarea name='uraian_kerja[]' class="form-control"
															placeholder="Input Uraian Kerja" maxlength='255'></textarea>
													</div>
												</div>
											</div>
											<div class="form-group-inner">
									...
									<div id='list_uraian_kerja'>
										...
										(int) $uraian_kerja_detail_count = set_value("jumlah_list_uraian_kerja") != "" ? set_value("jumlah_list_uraian_kerja") : 1;
										...
										<div class='list_uraian_kerja_detail'>
											...
											<div class="form-group-inner">
												<div class="row">
													...
													<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
														<textarea name='uraian_kerja[]' class="form-control"
															placeholder="Input Uraian Kerja" maxlength='255'><?php echo set_value("uraian_kerja[$index]"); ?></textarea>
											...
											<div class="form-group-inner">
												<div class="row">
													...
													<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
														<input type="number" value='<?php echo set_value("volume[$index]"); ?>'
															name='volume[]' class="form-control" placeholder="Input Volume" max='9999'>
											...
											<div class="form-group-inner">
												<div class="row">
													...
													<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
														<input type="number" value='<?php echo set_value("bobot_kontrak[$index]"); ?>'
															name='bobot_kontrak[]' class="form-control" placeholder="Input Bobot Kontrak dalam persen" max='100'>
