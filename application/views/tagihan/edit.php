					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="basic-login-inner">
								...
								<form action="<?php echo base_url("index.php/tagihan/{$data->id}/update"); ?>" method='post'>
										...
										<div class="row">
											...
											<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
												<input name='nama_tagihan' class="form-control"
													placeholder="Input Nama Tagihan" required maxlength='255' value='<?php echo $data->nama_tagihan ?? set_value('nama_tagihan'); ?>'>
									...
									<div class="form-group-inner">
										<div class="row">
											...
											<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
												<input type="date" value='<?php echo $data->tanggal ?? set_value('tanggal'); ?>'
										...
										<div class="row">
											...
											<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
												<input name='presentase' type="number" class="form-control"
													value='<?php echo $data->presentase ?? set_value('presentase'); ?>' min='1' max='100' required>
										...
										<div class="row">
											...
											<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
												<input name='nilai_tagihan' type="text" class="cleave1 form-control"
													value='<?php echo $data->nilai_tagihan ?? set_value('nilai_tagihan'); ?>' required>
										...
										<div class="row">
											...
											<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
												<textarea name='note' class="form-control"
													placeholder="Input Note" required maxlength='255'><?php echo $data->note ?? set_value('note'); ?></textarea>
