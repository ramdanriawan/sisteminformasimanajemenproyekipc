                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="basic-login-inner inline-basic-form">
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    <form action='<?php echo base_url('index.php/jadwal_rencana/search'); ?>' id='formTampilkan' method='post'>
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                            <input type="text" name='q' id='proyeks' class="form-control basic-ele-mg-b-10 responsive-mg-b-10" placeholder="Cari id / nama proyek" value='<?php echo $q ?? ""; ?>'>
                                                            <input type="hidden" id='id_proyek' class="form-control basic-ele-mg-b-10 responsive-mg-b-10" name='id_proyek' value='<?php echo $id_proyek ?? ""; ?>'>
                                                        </div>
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="number" id='minggu_ke' name='minggu_ke' class="form-control basic-ele-mg-b-10 responsive-mg-b-10" placeholder="Minggu Ke" value='<?php echo $minggu_ke ?? 1; ?>' min='1' max='100'>
                                                            </div>
                                                        </div>
                                                        </div>
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 jarakBtnTampilkan">
                                                            <div class="login-btn-inner">
                                                                <div class="row">
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                        <button class="btn btn-sm btn-primary" type="submit" id='submit' data-jadwal-rencana='1'>Tampilkan</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
