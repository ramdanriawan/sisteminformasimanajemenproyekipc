                ...
                <div class="sparkline13-list">
                    ...
                    <div class="sparkline13-graph">
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            <div id="toolbar">
                                <a id='inputBaru' class="inputAllUraianKerja btn btn-primary btn-small color-orange" href='<?php echo base_url("index.php/tagihan/create/" . $proyek_id ?? ""); ?>'>+Tagihan Baru</a>
                                <form id='deleteAllForm' action='<?php echo base_url('index.php/tagihan/deleteall'); ?>' method='post'>
                                    <input name='deleteAllInput' type='hidden' value=''/>
                                </form>
                                <button id='deleteAllUraianKerjaDanUraianKerjaDetails' class="deleteAllUraianKerja btn btn-danger btn-small color-orange" form='deleteAllForm' onclick='return confirm("yakin akan menghapus semua data yang telah dipilih?");' type='submit'>-Tagihan</button>
...
locationHrefTampilkanBerdasarkanProyek = "<?php echo base_url('index.php/tagihan/tampilkan_berdasarkan_proyek'); ?>/";
