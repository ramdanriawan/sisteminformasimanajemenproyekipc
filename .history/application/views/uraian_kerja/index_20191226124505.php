                        ...
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            <div id="toolbar">
                                <a id='inputBaru' class="inputAllUraianKerja btn btn-primary btn-small color-orange"
                                    href='<?php echo base_url('index.php/uraian_kerja/create/'.$proyek_id ?? ''); ?>'>+Uraian
                                    Kerja Baru</a>
                                <form id='deleteAllForm'
                                    action='<?php echo base_url('index.php/uraian_kerja/deleteall'); ?>' method='post'>
                                ...
                                <button id='deleteAllUraianKerjaDanUraianKerjaDetails'
                                    ...
                                    type='submit'>- Uraian Kerja</button>
...
<script>
    ...
    locationHrefTampilkanBerdasarkanProyek =
        "<?php echo base_url('index.php/uraian_kerja/tampilkan_berdasarkan_proyek'); ?>/";
</script>