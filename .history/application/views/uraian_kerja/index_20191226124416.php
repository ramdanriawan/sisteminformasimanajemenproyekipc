                            ...
                            <div class="basic-login-form-ad">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <form action ="<?php echo base_url('index.php/uraian_kerja/tampilkan_berdasarkan_proyek'); ?>" method='post'>
                                                        ...
                                                        <div class="form-group">
                                                            <select id="id_proyek" class="form-control" name="id_proyek">
                                                                ...
                                                                <?php foreach ($proyeks as $proyek): ?>
                                                                    <option value='<?php echo $proyek->id ?? ''; ?>' <?php if ($proyek->id == $proyek_id): echo 'selected'; endif; ?>><?php echo "ID: $proyek->id | $proyek->nama_proyek"; ?></option>
                                                                <?php endforeach; ?>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="login-btn-inner">
                                                            <div class="row">
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                    <button class="btn btn-sm btn-primary" type="submit" id='submit'>Tampilkan</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
