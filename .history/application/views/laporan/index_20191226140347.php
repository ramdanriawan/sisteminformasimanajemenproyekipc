    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="sparkline13-list">
            ...
            <div class="sparkline13-graph">
                <form id="formTampilkan" action='<?php echo base_url("index.php/laporan/tampilkanBerdasarkanProyek"); ?>' method='post'>
                    ...
                    <table id="table" data-toggle="table" data-pagination="false" data-search="false"
                        ...
                        <thead>
                            ...
                            <tr>
                                <th></th>
                                <th>Kontraktor</th>
                                <th>: &nbsp;&nbsp;<?php echo $this->Proyek->user($proyek->user_id)->nama_lengkap; ?></th>
                                <th colspan='13'></th>
                            </tr>
                            <tr>
                                <th></th>
                            ...
                            <tr>
                                ...
                                <th data-field="tipe_user" colspan='9' class='text-center line-height-50'>progres PEKERJAAN FISIK MINGGUAN</th>
